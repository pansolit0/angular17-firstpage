...
import {Cell2Component2} from "../../celdas-card/cell2/cell2.component";
@Component({
  selector: 'app-cell2g',
  standalone: true,
  imports: [HttpClientModule, Cell2Component2],
  templateUrl: './cell2.component.html',
  styleUrl: './cell2.component.css',
  providers:[MitablaServiceService]
})
export class Cell2ComponentO implements AfterViewInit, OnDestroy, OnInit {
